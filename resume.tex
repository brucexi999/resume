...
\cventry{2021--2024}{Master of Engineering in Electrical and Computer Engineering}{The University of British Columbia}{Vancouver, BC}{GPA 4.0}{
    \begin{itemize}
    \item Relevant courses: Digital/Microcomputer System Design, Computer Architecture, VLSI, High-speed Data Link, IC Testing and DFT, DNN Accelerator, Signals and Systems, Deep Learning, Formal Verification
\end{itemize}
}
...
\section{Skills}
\cvitem{Hardware}{Verilog, SystemVerilog, UVM, SVA, Altera FPGA, ModelSim, Quartus, Vivado, Cadence Virtuoso} 
