...
\cventry{2021--2024}{Master of Engineering in Electrical and Computer Engineering}{The University of British Columbia}{Vancouver, BC}{}{
    ...
    \item Relevant courses: Deep Learning, Computer Architecture, CNN Hardware Accelerator, Digital System Design
\end{itemize}
...
\section{Skills}
\cvitem{Hardware}{Verilog, FPGA, Assembly, Cadence}
\cvitem{Software}{Python, C, Linux, Git, Deep Learning, Reinforcement Learning}
