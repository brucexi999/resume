...
\usepackage{lmodern}
\usepackage[scale=0.8, top=0.9cm, bottom=0.9cm, left=1.5cm, right=1.5cm]{geometry}
% personal data
\name{Bruce}{Xi}
...
\cventry{2021--2025}{Master of Engineering in Electrical and Computer Engineering}{The University of British Columbia}{Vancouver, BC}{GPA 4.0}{
    \begin{itemize}
        \item In-depth knowledge in \textbf{ATE, test pattern generation}, fault modeling and simulation, and testability measures
    \end{itemize}
}
...
\cvitem{Software}{Python, C/C++, Assembly, Linux}
